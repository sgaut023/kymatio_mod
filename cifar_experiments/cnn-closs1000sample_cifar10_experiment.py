...
mlflow_exp_name = "\"CNN cosine loss Cifar-10 100 samples batch norm affine\""
...
if __name__ == '__main__':
    ...
    for SEED in [737523103,207715039,491659600,493572006,827192296,877498678,1103100946,1210393663,1277404878,1377264326]:
        ...
        # SEED = int(time.time() * np.random.rand(1))
        for aa in [(0,"Kymatio",25),(1,"Kymatio",25),(0,"Random",25),(0,"Random",25)]:#,(0,"Kymatio"),(1,"Random"),(0,"Random")]:
            LEARNABLE, INIT, DF = aa
            ...
            args3 = "-smaxlr {} -sdivf {} -stp {} -mloss {} -otp {} -dg {}".format(
                SCATT_LRMAX,SCATT_DF,SCATT_THREE_PHASE,MODEL_LOSS,THREE_PHASE,GLICO
            )
