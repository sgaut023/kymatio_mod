...
if __name__ == '__main__':
    ...
    for SEED in [491659600,207715039,737523103,493572006,827192296,877498678,1103100946,1210393663,1277404878,1377264326]:
        ...
        args2 = "-os {} -daug {} -en {} -dtbs {} -mname {}".format(
            SCHEDULER,AUGMENT,mlflow_exp_name,TRAIN_BATCH_SIZE,MODEL
        )

        args3 = "-mloss {} -sa {} -mw {} -dtstbs {}".format(
            MODEL_LOSS,SCATT_ARCH,MODEL_WIDTH,TEST_BATCH_SIZE
        )
