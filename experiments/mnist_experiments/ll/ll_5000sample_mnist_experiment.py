...
mlflow_exp_name = "\"SN+LL cross-entropy 5000 samples MNIST\""
...
if __name__ == '__main__':
    ...
    for SEED in [207715039,491659600,737523103,493572006,827192296,877498678,1103100946,1210393663,1277404878,1377264326]: #, 491659600,737523103,493572006,827192296,877498678,1103100946,1210393663,1277404878,1377264326
