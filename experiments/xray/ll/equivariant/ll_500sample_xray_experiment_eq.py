...
if __name__ == '__main__':
    ...
    for SEED in [433842091,637789757,706825958,750490779,884698041,1065155395,1452034008,1614090550]: #22942091,313350229
        for aa in [(1,"Tight-Frame"),(1,"Random")]:
            ...
            args3 = "-slrs {} -slro {} -seq {}".format(
                LRS,LRO, EQUIVARIANCE)
