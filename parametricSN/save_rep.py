...
def run_train(args):
    ...
    hybridModel.load_state_dict(torch.load("hmodel_L14.pt"))

    fake_image = torch.randn(100,3,32,32,device=device)
    scattering_representation = hybridModel.scatteringBase(fake_image)
    print("Scattering representation size: {}".format(scattering_representation.shape))
    print("save your images here ")
