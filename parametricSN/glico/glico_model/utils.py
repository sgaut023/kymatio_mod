...
def get_loader_with_idx(dataset, batch_size, image_size, rand_crop, mean=None, std=None, num_workers=6,
                        ...
                        random_erase=False):
	'''Returns dataloader of a custimized dataset which links together the indices and the images
	...
	print(f"[Generated data loader], resolution:{image_size}x{image_size}, workers:{num_workers}, sampler:{sampler}, transformation:{transform} ")
